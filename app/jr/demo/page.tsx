...
const DEMO_STATIONS = [
  {
    ...
    label: "大宮",
    pocContext: {
      summary: "ecute 大宮の南北2棟・施設探索と送客最適化",
      detail:
        "サウス館・ノース館に分かれた ecute 大宮と、南口・北口の複数改札をまたいだ施設閲覧・利用パターンを可視化。どちらの改札から入り、どちらの棟のどの施設に立ち寄るかを計測する。",
      verifyPoints: [
        "南口/北口改札別の施設利用パターン計測",
